...
<section class="categories">
    <div class="category-box">
        <a href="<?= BASE_URL ?>/shop-men">
            <div class="img-container">
                <img src="<?= BASE_URL ?>/public/images/productImages/home_men_polo_tank.png" alt="Shop Men">
    ...
    <div class="category-box">
        <a href="<?= BASE_URL ?>/shop-women">
            <div class="img-container">
                <img src="<?= BASE_URL ?>/public/images/productImages/women_polo_tee.png" alt="Shop Women">
...
<section class="just-in">
    ...
    <div class="products">
        ...
        <div class="product-card">
            <img src="<?= BASE_URL ?>/public/images/productImages/home_women_running_spikes.png" alt="Women Running Spikes">
        ...
        <div class="product-card">
            <img src="<?= BASE_URL ?>/public/images/productImages/home_men_football_boot.png" alt="Men Football Boots">
        ...
        <div class="product-card">
            <img src="<?= BASE_URL ?>/public/images/productImages/home_women_running_shoes.png" alt="Women Running Shoes">
